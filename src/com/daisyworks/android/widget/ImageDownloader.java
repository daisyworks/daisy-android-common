...
public class ImageDownloader
{
  ...
  protected final Bitmap defaultBitMap;

  public ImageDownloader(final Bitmap defaultBitMap)
  {
  ...
  private void forceDownload(final String url, final ImageView imageView)
  {
    ...
    if (cancelPotentialDownload(url, imageView))
    {
      ...
      case CORRECT:
        ...
        DownloadedDrawable downloadedDrawable = new DownloadedDrawable(imageView.getResources(), defaultBitMap, task);
   ...
   */
  protected static BitmapDownloaderTask getBitmapDownloaderTask(final ImageView imageView)
  {
    if (imageView != null)
    {
  ...
  static class DownloadedDrawable extends BitmapDrawable
  {
    ...
    public DownloadedDrawable (final Resources resources, final Bitmap defaultBitmap, final BitmapDownloaderTask bitmapDownloaderTask)
    {
  ...
  protected final static ConcurrentHashMap<String, SoftReference<Bitmap>> sSoftBitmapCache = new ConcurrentHashMap<String, SoftReference<Bitmap>>(HARD_CACHE_CAPACITY / 2);
   ...
   */
  void addBitmapToCache(final String url, final Bitmap bitmap)
  {
    if (bitmap != null)
    {
